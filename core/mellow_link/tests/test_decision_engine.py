...
class OrderRepository:
    ...
    assert decisions.template_judgment == decisions.primary_judgment
    assert decisions.structural_judgment == "redesign"
    assert decisions.narrative_axis
    assert decisions.feature_signal_mode
