...
| File | Path |
|------|------|
| **Mellow-Link .env** | `C:\Users\Hyein\ClaudeAI\AI_Project\mellow_link\.env` |
| **Mellow-Link settings.py** | `C:\Users\Hyein\ClaudeAI\AI_Project\mellow_link\config\settings.py` |
| **Open-LLM-VTuber conf.yaml** | `C:\Users\Hyein\ClaudeAI\AI_Project\Open-LLM-VTuber\conf.yaml` |

### Live2D Models

| Location | `C:\Users\Hyein\ClaudeAI\AI_Project\Open-LLM-VTuber\live2d\` |
|----------|------------------------------------------|
...
**Persona File:** `C:\Users\Hyein\ClaudeAI\AI_Project\mellow_link\prompts\aventurine_persona_v1.txt`
...
| Question | Answer |
|----------|--------|
| Where is the model file? | `C:\Users\Hyein\ClaudeAI\AI_Project\Open-LLM-VTuber\live2d\haruto\` |
| Where is the config? | `C:\Users\Hyein\ClaudeAI\AI_Project\Open-LLM-VTuber\conf.yaml` |
...
| Where are audio files cached? | `C:\Users\Hyein\ClaudeAI\AI_Project\Open-LLM-VTuber\cache\` |
