...
class VideoRequest(BaseModel):
    ...
    Blind Build 단계에서는 "이미지 경로"를 받아 ComfyUI(SVD 워크플로우)로 전달하는
    최소한의 필드만 포함한다.
    """
